...
class WeatherInfoBody extends StatelessWidget {
    WeatherInfoBody({Key? key, required this.weatharModel}) : super(key: key);
...
decoration: BoxDecoration(
      ...
      gradient: LinearGradient(
        ...
        colors: [
          getThemeColor(weatharModel.weatherCondition).shade50,
          getThemeColor(weatharModel.weatherCondition).shade300,
        ],
      ),
),      child: Padding(
